...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntryInSchool.phone_code'
        db.add_column('messages_entryinschool', 'phone_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'PartnershipOffer.phone_code'
        db.add_column('messages_partnershipoffer', 'phone_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntryInSchool.phone_code'
        db.delete_column('messages_entryinschool', 'phone_code')

        # Deleting field 'PartnershipOffer.phone_code'
        db.delete_column('messages_partnershipoffer', 'phone_code')
    ...
    models = {
        'messages.entryinschool': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 24, 0, 0)'}),
        ...
        'products.product': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 24, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        }
    }
