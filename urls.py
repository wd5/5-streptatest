...
urlpatterns = patterns('',
    ...
    url(r'^reviews/patients/more/$', MoreReviewsView.as_view(), {'reviewer_type':'patient'}, name='patients_more_url'),
    url(r'^reviews/doctors/more/$', MoreReviewsView.as_view(), {'reviewer_type':'doctor'}, name='doctors_more_url'),
    url(r'^reviews/patients/form/$', ReviewFormView.as_view()),
    url(r'^reviews/doctors/form/$', ReviewFormView.as_view()),
    # capabilities
